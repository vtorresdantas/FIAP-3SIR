...
class PhraseRepository {
    ...
    private val all = PhraseType.ALL
    private val happy = PhraseType.HAPPY
    private val sunny = PhraseType.SUNNY
    ...
    fun getPhrase(value: PhraseType): Phrase {
        val filtered = listPhrases.filter { (it.type == value || value == all) }
